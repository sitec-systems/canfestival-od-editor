...
class CommunicationDialog(wx.Dialog):
    def _init_coll_flexGridSizer1_Items(self, parent):
        parent.Add(self.MainSizer,
                   0,
                   border=20,
                   flag=wx.GROW | wx.TOP | wx.LEFT | wx.RIGHT)
        parent.Add(self.ButtonSizer,
                   0,
                   border=20,
    ...
    def _init_sizers(self):
        ...
        self.MiddleGridSizer = wx.FlexGridSizer(cols=1,
                                                hgap=0,
                                                rows=2,
                                                vgap=40)
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self,
                           id=ID_COMMUNICATIONDIALOG,
                           name='CommunicationDialog',
                           parent=prnt,
                           pos=wx.Point(234, 216),
                           size=wx.Size(726, 437),
        ...
        self.staticText1 = wx.StaticText(id=ID_COMMUNICATIONDIALOGSTATICTEXT1,
                                         label=_('Possible Profile Indexes:'),
                                         name='staticText1',
                                         parent=self,
                                         pos=wx.Point(0, 0),
                                         size=wx.Size(0, 17),
        ...
        self.PossibleIndexes = wx.ListBox(
            choices=[],
        ...
        self.Bind(wx.EVT_LISTBOX_DCLICK,
                  self.OnPossibleIndexesDClick,
                  id=ID_COMMUNICATIONDIALOGPOSSIBLEINDEXES)

        self.Select = wx.Button(id=ID_COMMUNICATIONDIALOGSELECT,
                                label='>>',
                                name='Select',
                                parent=self,
                                pos=wx.Point(0, 0),
                                size=wx.Size(32, 32),
                                style=0)
        self.Select.Bind(wx.EVT_BUTTON,
                         self.OnSelectButton,
        ...
        self.CurrentIndexes = wx.ListBox(
            choices=[],
    ...
    def RefreshLists(self):
        ...
        self.AllList = []
        for index in list(self.IndexDictionary.keys()):
...
[
    ID_MAPVARIABLEDIALOG,
    ID_MAPVARIABLEDIALOGINDEX,
    ID_MAPVARIABLEDIALOGINDEXNAME,
    ID_MAPVARIABLEDIALOGSPACER,
    ID_MAPVARIABLEDIALOGSPACER2,
    ID_MAPVARIABLEDIALOGNUMBER,
    ID_MAPVARIABLEDIALOGRADIOBUTTON1,
    ID_MAPVARIABLEDIALOGRADIOBUTTON2,
    ID_MAPVARIABLEDIALOGRADIOBUTTON3,
    ID_MAPVARIABLEDIALOGSTATICTEXT1,
    ID_MAPVARIABLEDIALOGSTATICTEXT2,
    ID_MAPVARIABLEDIALOGSTATICTEXT3,
...
class MapVariableDialog(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self,
                           id=ID_MAPVARIABLEDIALOG,
                           name='CommunicationDialog',
                           parent=prnt,
                           pos=wx.Point(376, 223),
                           size=wx.Size(444, 186),
        ...
        self.radioButton3.Bind(wx.EVT_RADIOBUTTON,
                               self.OnRadioButton3Click,
                               id=ID_MAPVARIABLEDIALOGRADIOBUTTON3)

        self.Index = wx.TextCtrl(id=ID_MAPVARIABLEDIALOGINDEX,
                                 name='Index',
                                 parent=self,
                                 pos=wx.Point(0, 0),
                                 size=wx.Size(0, 25),
...
[
    ID_USERTYPEDIALOG,
    ID_USERTYPEDIALOGSPACER,
    ID_USERTYPEDIALOGTYPE,
    ID_USERTYPEDIALOGMAX,
    ID_USERTYPEDIALOGMIN,
    ID_USERTYPEDIALOGLENGTH,
    ID_USERTYPEDIALOGSTATICBOX1,
    ID_USERTYPEDIALOGSTATICTEXT1,
    ID_USERTYPEDIALOGSTATICTEXT2,
    ID_USERTYPEDIALOGSTATICTEXT3,
...
class UserTypeDialog(wx.Dialog):
    ...
    def _init_sizers(self):
        ...
        self.RightBoxGridSizer = wx.FlexGridSizer(cols=2,
                                                  hgap=5,
                                                  rows=3,
                                                  vgap=10)
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self,
                           id=ID_USERTYPEDIALOG,
                           name='UserTypeDialog',
                           parent=prnt,
                           pos=wx.Point(376, 223),
                           size=wx.Size(444, 210),
                           style=wx.DEFAULT_DIALOG_STYLE,
                           title=_('Add User Type'))
        ...
        self.Type.Bind(wx.EVT_COMBOBOX,
                       self.OnTypeChoice,
                       id=ID_USERTYPEDIALOGTYPE)
        ...
        self.Min = wx.TextCtrl(id=ID_USERTYPEDIALOGMIN,
                               name='Min',
                               parent=self,
                               pos=wx.Point(0, 0),
                               size=wx.Size(0, 24),
        ...
        self.Max = wx.TextCtrl(id=ID_USERTYPEDIALOGMAX,
                               name='Max',
                               parent=self,
                               pos=wx.Point(0, 0),
                               size=wx.Size(0, 24),
        ...
        self.Length = wx.TextCtrl(id=ID_USERTYPEDIALOGLENGTH,
                                  name='Length',
                                  parent=self,
                                  pos=wx.Point(0, 0),
                                  size=wx.Size(0, 24),
    ...
    def OnOK(self, event):
        ...
        if message is not None:
            message = wx.MessageDialog(
                self,
                _("Form isn't valid. %s") % (firstmessage, secondmessage),
                _("Error"), wx.OK | wx.ICON_ERROR)
            message.ShowModal()
            message.Destroy()
        else:
    ...
    def SetTypeList(self, typedic, type=None):
        self.Type.Clear()
        list = []
        for index, (name, valuetype) in list(typedic.items()):
...
[
    ID_NODEINFOSDIALOG,
    ID_NODEINFOSDIALOGNAME,
    ID_NODEINFOSDIALOGNODEID,
    ID_NODEINFOSDIALOGTYPE,
    ID_NODEINFOSDIALOGDEFAULTSTRINGSIZE,
    ID_NODEINFOSDIALOGDESCRIPTION,
    ID_NODEINFOSDIALOGSTATICTEXT1,
    ID_NODEINFOSDIALOGSTATICTEXT2,
    ID_NODEINFOSDIALOGSTATICTEXT3,
...
class NodeInfosDialog(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self,
                           id=ID_NODEINFOSDIALOG,
                           name='NodeInfosDialog',
                           parent=prnt,
                           pos=wx.Point(376, 223),
                           size=wx.Size(300, 280),
                           style=wx.DEFAULT_DIALOG_STYLE,
                           title=_('Node infos'))
        ...
        self.NodeName = wx.TextCtrl(id=ID_NODEINFOSDIALOGNAME,
                                    name='NodeName',
                                    parent=self,
                                    pos=wx.Point(0, 0),
                                    size=wx.Size(0, 24),
        ...
        self.NodeID = wx.TextCtrl(id=ID_NODEINFOSDIALOGNODEID,
                                  name='NodeID',
                                  parent=self,
                                  pos=wx.Point(0, 0),
                                  size=wx.Size(0, 25),
        ...
        self.DefaultStringSize = wx.SpinCtrl(
    ...
    def OnOK(self, event):
        ...
        if name != "":
            ...
            if not good:
                message = _(
                    "Node name can't be undefined or start with a digit and must be composed of alphanumerical characters or underscore!"
                )
        if message != "":
            try:
        ...
        if message != "":
            message = wx.MessageDialog(self, message, _("ERROR"),
                                       wx.OK | wx.ICON_ERROR)
            message.ShowModal()
            message.Destroy()
...
[
    ID_CREATENODEDIALOG,
    ID_CREATENODEDIALOGEMERGENCY,
    ID_CREATENODEDIALOGGENSYNC,
    ID_CREATENODEDIALOGSPACER,
    ID_CREATENODEDIALOGNAME,
    ID_CREATENODEDIALOGNMT_HEARTBEAT,
    ID_CREATENODEDIALOGNMT_NODEGUARDING,
    ID_CREATENODEDIALOGNMT_NONE,
    ID_CREATENODEDIALOGNODEID,
    ID_CREATENODEDIALOGPROFILE,
    ID_CREATENODEDIALOGSAVECONFIG,
    ID_CREATENODEDIALOGSTATICTEXT1,
    ID_CREATENODEDIALOGSTATICTEXT2,
    ID_CREATENODEDIALOGSTATICTEXT3,
    ID_CREATENODEDIALOGSTATICTEXT4,
    ID_CREATENODEDIALOGSTATICTEXT5,
    ID_CREATENODEDIALOGSTATICTEXT6,
    ID_CREATENODEDIALOGSTATICTEXT7,
    ID_CREATENODEDIALOGSTOREEDS,
    ID_CREATENODEDIALOGDESCRIPTION,
...
class CreateNodeDialog(wx.Dialog):
    ...
    def _init_sizers(self):
        ...
        self.RightTopGridSizer = wx.FlexGridSizer(cols=1,
                                                  hgap=0,
                                                  rows=4,
                                                  vgap=0)
        self.RightBottomGridSizer = wx.FlexGridSizer(cols=1,
                                                     hgap=0,
                                                     rows=6,
                                                     vgap=0)
        ...
        self._init_coll_RightBottomGridSizer_Growables(
            self.RightBottomGridSizer)

        self.SetSizer(self.flexGridSizer1)

    def _init_ctrls(self, prnt, buttons):
        wx.Dialog.__init__(self,
                           id=ID_CREATENODEDIALOG,
        ...
        self.NodeName = wx.TextCtrl(id=ID_CREATENODEDIALOGNAME,
                                    name='NodeName',
                                    parent=self,
                                    pos=wx.Point(0, 0),
                                    size=wx.Size(0, 24),
        ...
        self.NodeID = wx.TextCtrl(id=ID_CREATENODEDIALOGNODEID,
                                  name='NodeID',
                                  parent=self,
                                  pos=wx.Point(0, 0),
                                  size=wx.Size(0, 24),
        ...
        self.NMT_NodeGuarding = wx.RadioButton(
            id=ID_CREATENODEDIALOGNMT_NODEGUARDING,
            label=_('Node Guarding'),
            name='NMT_NodeGuarding',
            parent=self,
            pos=wx.Point(0, 0),
            size=wx.Size(0, 24),
            style=0)
        ...
        self.NMT_Heartbeat = wx.RadioButton(
            id=ID_CREATENODEDIALOGNMT_HEARTBEAT,
            label=_('Heartbeat'),
            name='NMT_Heartbeat',
            parent=self,
            pos=wx.Point(0, 0),
    ...
    def __init__(self, parent, buttons=wx.OK | wx.CANCEL):
        ...
        for item in listfiles:
            ...
            if os.path.isfile(os.path.join(
                    self.Directory,
                    item)) and extend == ".prf" and name != "DS-302":
    ...
    def OnProfileChoice(self, event):
        if self.Profile.GetStringSelection() == _("Other"):
            dialog = wx.FileDialog(
                self, _("Choose a file"), self.Directory, "",
                _("OD Profile files (*.prf)|*.prf|All files|*.*"),
...
[
    ID_ADDSLAVEDIALOG,
    ID_ADDSLAVEDIALOGSLAVENAME,
    ID_ADDSLAVEDIALOGSLAVENODEID,
    ID_ADDSLAVEDIALOGEDSFILE,
    ID_ADDSLAVEDIALOGIMPORTEDS,
    ID_ADDSLAVEDIALOGSTATICTEXT1,
    ID_ADDSLAVEDIALOGSTATICTEXT2,
    ID_ADDSLAVEDIALOGSTATICTEXT3,
...
class AddSlaveDialog(wx.Dialog):
    ...
    def _init_ctrls(self, prnt):
        ...
        self.ImportEDS = wx.Button(id=ID_ADDSLAVEDIALOGIMPORTEDS,
                                   label=_('Import EDS'),
                                   name='ImportEDS',
                                   parent=self,
                                   pos=wx.Point(0, 0),
                                   size=wx.Size(100, 32),
                                   style=0)
        self.ImportEDS.Bind(wx.EVT_BUTTON,
                            self.OnImportEDSButton,
    ...
    def OnOK(self, event):
        ...
        if len(error) > 0:
            ...
            try:
                ...
                message = wx.MessageDialog(
                    self,
                    _("Slave Node ID must be a value in decimal or hexadecimal!"
                      ), _("Error"), wx.OK | wx.ICON_ERROR)
                message.ShowModal()
                message.Destroy()
                return
            if not 0 <= nodeid <= 127:
                message = wx.MessageDialog(
                    self, _("Slave Node ID must be between 0 and 127!"),
                    _("Error"), wx.OK | wx.ICON_ERROR)
                message.ShowModal()
                message.Destroy()
            elif nodeid == self.NodeList.GetMasterNodeID(
            ) or nodeid in self.NodeList.GetSlaveIDs():
                message = wx.MessageDialog(
                    self,
                    _("A Node with this ID already exist in the network!"),
                    _("Error"), wx.OK | wx.ICON_ERROR)
                message.ShowModal()
                message.Destroy()
            else:
    ...
    def OnImportEDSButton(self, event):
        dialog = wx.FileDialog(self, _("Choose an EDS file"),
                               os.path.expanduser("~"), "",
        ...
        if os.path.isfile(filepath):
            ...
            if result is not None and question:
                ...
                if dialog.ShowModal() == wx.ID_YES:
                    result, question = self.NodeList.ImportEDSFile(
                        filepath, True)
                dialog.Destroy()
            if result is not None and not question:
                dialog = wx.MessageDialog(self, result, _("Error"),
                                          wx.OK | wx.ICON_ERROR)
                dialog.ShowModal()
                dialog.Destroy()
        self.RefreshEDSFile()
...
[
    ID_DCFENTRYVALUESDIALOG,
    ID_DCFENTRYVALUESDIALOGVALUESGRID,
    ID_DCFENTRYVALUESDIALOGADDBUTTON,
    ID_DCFENTRYVALUESDIALOGDELETEBUTTON,
    ID_DCFENTRYVALUESDIALOGUPBUTTON,
    ID_DCFENTRYVALUESDIALOGDOWNBUTTON,
...
class DCFEntryValuesDialog(wx.Dialog):
    ...
    def _init_coll_MainSizer_Items(self, parent):
        parent.Add(self.staticText1,
                   0,
                   border=20,
                   flag=wx.GROW | wx.TOP | wx.LEFT | wx.RIGHT)
        parent.Add(self.ValuesGrid,
                   0,
                   border=20,
                   flag=wx.GROW | wx.TOP | wx.LEFT | wx.RIGHT)
        parent.Add(self.ButtonPanelSizer,
                   0,
                   border=20,
                   flag=wx.ALIGN_RIGHT | wx.LEFT | wx.RIGHT)
        parent.Add(self.ButtonSizer,
                   0,
                   border=20,
                   flag=wx.ALIGN_RIGHT | wx.BOTTOM | wx.LEFT | wx.RIGHT)
    ...
    def _init_ctrls(self, prnt):
        wx.Dialog.__init__(self,
                           id=ID_DCFENTRYVALUESDIALOG,
                           name='DCFEntryValuesDialog',
                           parent=prnt,
                           pos=wx.Point(376, 223),
        ...
        self.ValuesGrid = wx.grid.Grid(id=ID_DCFENTRYVALUESDIALOGVALUESGRID,
                                       ...
                                       size=wx.Size(0, 150),
                                       style=wx.VSCROLL)
        self.ValuesGrid.SetFont(
            wx.Font(12, 77, wx.NORMAL, wx.NORMAL, False, 'Sans'))
        self.ValuesGrid.SetLabelFont(
        ...
        if wx.VERSION >= (2, 6, 0):
            self.ValuesGrid.Bind(wx.grid.EVT_GRID_CELL_CHANGE,
                                 self.OnValuesGridCellChange)
            self.ValuesGrid.Bind(wx.grid.EVT_GRID_SELECT_CELL,
                                 self.OnValuesGridSelectCell)
        else:
            wx.grid.EVT_GRID_CELL_CHANGE(self.ValuesGrid,
                                         self.OnValuesGridCellChange)
            wx.grid.EVT_GRID_SELECT_CELL(self.ValuesGrid,
                                         self.OnValuesGridSelectCell)

        self.AddButton = wx.Button(id=ID_DCFENTRYVALUESDIALOGADDBUTTON,
                                   label=_('Add'),
                                   name='AddButton',
                                   parent=self,
                                   pos=wx.Point(0, 0),
        ...
        self.Bind(wx.EVT_BUTTON,
                  self.OnAddButton,
                  id=ID_DCFENTRYVALUESDIALOGADDBUTTON)

        self.DeleteButton = wx.Button(id=ID_DCFENTRYVALUESDIALOGDELETEBUTTON,
                                      label=_('Delete'),
                                      name='DeleteButton',
                                      parent=self,
                                      pos=wx.Point(0, 0),
        ...
        self.Bind(wx.EVT_BUTTON,
                  self.OnDeleteButton,
                  id=ID_DCFENTRYVALUESDIALOGDELETEBUTTON)

        self.UpButton = wx.Button(id=ID_DCFENTRYVALUESDIALOGUPBUTTON,
                                  label='^',
                                  name='UpButton',
                                  parent=self,
                                  pos=wx.Point(0, 0),
        ...
        self.Bind(wx.EVT_BUTTON,
                  self.OnUpButton,
                  id=ID_DCFENTRYVALUESDIALOGUPBUTTON)

        self.DownButton = wx.Button(id=ID_DCFENTRYVALUESDIALOGDOWNBUTTON,
                                    label='v',
                                    name='DownButton',
                                    parent=self,
                                    pos=wx.Point(0, 0),
        ...
        self.Bind(wx.EVT_BUTTON,
                  self.OnDownButton,
                  id=ID_DCFENTRYVALUESDIALOGDOWNBUTTON)
    ...
    def OnValuesGridCellChange(self, event):
        ...
        try:
            ...
            message = wx.MessageDialog(
                self,
                _("\"%s\" is not a valid value!") % value, _("Error"),
                wx.OK | wx.ICON_ERROR)
            message.ShowModal()
            message.Destroy()
